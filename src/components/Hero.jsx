  ...
  return (
    <section className={'relative w-full h-screen mx-auto'}>
      ...
      className={`absolute inset-0 top-[80px]  max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
        <div className="flex flex-co1 justify-center items-center mt-5">
          {/* <div className="w-4 h-4 rounded-full bg-[#915eff]" /> */}
          <div className="w-1 sm:h-80 h-40 violet-gradient"/>
        </div>
        <div>
           <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Sadiq</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            A budding 3D & web developer 
            <br className='sm:block hidden' />
            Keen to learn & create amazing things!
          </p>
        </div>
      </div>
      <ComputersCanvas />
